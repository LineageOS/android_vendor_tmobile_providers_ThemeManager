...
public class ThemeUtilities {
    ...
    private static void applyStyleInternal(Context context, ThemeItem theme) {
        ...
        Themes.markAppliedTheme(context, theme.getPackageName(), theme.getPackageName());
    ...
    public static List<PackageInfo> getInstalledThemePackages(Context context) {
        ...
        List<PackageInfo> installedPackagesList = context.getPackageManager().getInstalledPackages(0);
